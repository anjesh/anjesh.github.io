...
author: "Anjesh"
date: "`r format(Sys.time(), tz='Asia/Kathmandu')`"
output: 
  html_document:
    toc: true
...
Thank you for reading through. Any questions or suggestions? Please ask me <a href="https://twitter.com/anjesh">@twitter</a>
